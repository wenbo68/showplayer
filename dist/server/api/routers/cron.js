...
import { z } from 'zod';
import { fetchSrc, populateMediaUsingTmdbLists, processUserSubmissions, updateAllChangedMedia, updateAllPopularity, updateDenormFieldsForMediaList, updateRatings, } from '~/server/utils/cronUtils';
...
export const cronRouter = createTRPCRouter({
    runCron: protectedProcedure
        ...
        try {
            ...
            console.error(`[runCron] processUserSubmissions failed. Error: `, error);
        }
        ...
        try {
            ...
            console.error(`[runCron] populateMediaUsingTmdbLists failed. Error: `, error);
        }
        ...
        try {
            ...
            console.error(`[runCron] updateDenormFieldsForMediaList failed. Error: `, error);
        }
