// ====== maps
export const indexProviderMap = {
    1: 'videasy',
    2: 'vidjoy',
    3: 'vidlink',
    4: 'vidfast',
};
export const providerIndexMap = {
    videasy: 1,
    vidjoy: 2,
    vidlink: 3,
    vidfast: 4,
};
export const mvProvidersMap = {
...
// ====== selectors
export const videoSelectorsMap = {
    videasy: 'video',
};
export const playButtonSelectorsMap = {
...
export const settingsButtonSelectorsMap = {
    vidjoy: '#media-menu-button-4',
};
export const highestResolutionSelectorsMap = {
    vidjoy: '::-p-xpath(//button[contains(text(), "p")])',
};
export const subtitleButtonSelectorsMap = {
...
export const subtitleTabSelectorsMap = {
    videasy: '::-p-xpath(//button[span[starts-with(text(), "Subtitles")]])',
};
export const enSubtitleSelectorsMap = {
    vidjoy: generateEnSubtitleSelector('::-p-xpath(//button[h1[contains(text(), "")]])'),
    videasy: generateEnSubtitleSelector('::-p-xpath(//button[span[contains(text(), "")]])'),
    vidfast: generateEnSubtitleSelector('::-p-xpath(//div[div[contains(text(), "")]])'),
    vidlink: generateEnSubtitleSelector('::-p-xpath(//div[span[contains(text(), "")]])'),
...
export function generateEnSubtitleSelector(selector) {
    const variations = [
        'en',
        'En',
        'EN',
...
export async function clickPlayInFrame(provider, page) {
    try {
        ...
        const playButton = await frame.waitForSelector(playButtonSelectorsMap[provider] ?? '', {
            visible: true,
        });
...
export async function findAndClick(provider, name, selector, page) {
    try {
        const t1 = performance.now();
        // 1. find the thing
        await page.waitForSelector(selector, {
            visible: true,
            timeout: name === firstClickMap[provider] // takes abt 2500-3000
