...
const CarouselIndicator = ({
  ...
  <button
    ...
    className={`h-0.5 w-2 rounded transition-all duration-300 ${
      currentIndex === index ? 'bg-gray-300 scale-125' : 'bg-gray-700'
    }`}
...
export default function TrendingCarousel({
  ...
  return (
    <div
      {...handlers}
      className="relative w-full aspect-video max-h-[75vh] overflow-hidden"
    >
      {/* Slides Container */}
